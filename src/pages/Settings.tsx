...
export const Settings: React.FC<SettingsProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <PageHeader
        title="Settings & More"
        description="Manage shop preferences and quick tools"
      />
      ...
      <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-xs flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-md border border-emerald-200">
            Kirana & General Retail
          </span>
          <h2 className="text-xl font-extrabold text-slate-900 truncate mt-1">
            {shopName}
          </h2>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xs divide-y divide-slate-100 overflow-hidden">
        <div className="p-4 bg-slate-50 text-xs font-bold text-slate-600 uppercase tracking-wider">
          Quick Tools
        </div>
        ...
        >
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">Scan Supplier Invoice</p>
              <p className="text-xs text-slate-500">Snap paper bills to auto-fill stock</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">Shop Analytics & Trends</p>
              <p className="text-xs text-slate-500">View weekly sales and top categories</p>
            </div>
          </div>
          <ChevronRight className="w-5 h-5 text-slate-400 group-hover:translate-x-0.5 transition-transform" />
        </button>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xs divide-y divide-slate-100 overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">Currency Format</p>
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">Low Stock Alerts</p>
              <p className="text-xs text-slate-500">Highlight items when below minimum threshold</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xs divide-y divide-slate-100 overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">ShopPulse Support Line</p>
              <p className="text-xs text-slate-500">Toll Free: 1800-SHOP-PULSE</p>
            </div>
          </div>
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-base">App Version</p>
              <p className="text-xs text-slate-500">ShopPulse Mobile Assistant v0.1.0 (Phase 0)</p>
            </div>
          </div>
      ...
      <button
        onClick={onLogout}
        className="w-full py-4 px-6 rounded-2xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 font-extrabold text-base flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-xs"
      >
